...
```typescript
type BlockType = "text" | "heading" | "image" | "video" | "code" | "embed" | "project-card" | "service-card" | "collapsible" | "columns";
...
This allows the _Project Detail View_ to be just as editable and rich as the homepage.
