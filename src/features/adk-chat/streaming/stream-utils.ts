 ...
 */
export function truncateForLogging(data: string, maxLength: number = 200): string {
 ...
 */
export function formatFunctionCall(name: string, args: Record<string, unknown>): string {
 ...
 * @returns Formatted display string
 */
export function formatFunctionResponse(name: string, response: Record<string, unknown>): string {
