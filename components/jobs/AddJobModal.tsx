    ...
    const handleAnalyze = () => {
        ...
        setTimeout(() => {
            const mockJob: Job = {
                ...
                logo: 'https://ui-avatars.com/api/?name=Airbnb&background=FF5A5F&color=fff',
                description: "We are looking for a Senior Product Designer to join our core experience team. You will be responsible for defining the future of travel experiences.",
                isSponsoring: true
            };
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-2">
                                Paste the link from LinkedIn, Indeed, or a company career page.
                            </p>
                        </div>
                    ...
                    <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
                        <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 flex items-start gap-4">
                            <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-sm border border-slate-100">
                                <img src={analyzedJob.logo} className="w-8 h-8 object-contain" alt="logo" />
                            </div>
                            <div>
