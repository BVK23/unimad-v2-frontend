  ...
  return (
    <HandDrawnSvg className={`cl-art-letter ${className}`}>
      <path
        ...
        {...strokeProps}
      />
      <path d="M26 26h18" stroke={p.stroke} strokeWidth="2" className="cl-letter-line cl-letter-line-1" opacity="0" {...strokeProps} />
      <path d="M26 33h14" stroke={p.stroke} strokeWidth="2" className="cl-letter-line cl-letter-line-2" opacity="0" {...strokeProps} />
      <path d="M26 40h16" stroke={p.stroke} strokeWidth="2" className="cl-letter-line cl-letter-line-3" opacity="0" {...strokeProps} />
      <g className="cl-letter-pen">
        <path d="M44 48l9 8-3 3-9-8 3-3z" fill={p.accent} stroke={p.stroke} strokeWidth="2" {...strokeProps} />
        <path d="M44 48l-4-7 4-2 5 7-5 2z" fill={p.highlight} stroke={p.stroke} strokeWidth="2" {...strokeProps} />
      </g>
    </HandDrawnSvg>
  );
}
    ...
    <HandDrawnSvg className={`cl-art-email ${className}`}>
      ...
      <g className="cl-email-group">
        <path
          ...
          {...strokeProps}
        />
        <path d="M17 24l17 13 17-13" fill="none" stroke={p.stroke} strokeWidth="2" {...strokeProps} />
      </g>
    </HandDrawnSvg>
  );
}
  ...
  return (
    <HandDrawnSvg className={`cl-art-referral ${className}`}>
      <g className="cl-referral-orbit-system" style={{ transformOrigin: "36px 38px" }}>
        ...
        />
        <circle cx="58" cy="38" r="3.5" fill={p.accent} stroke={p.stroke} strokeWidth="1.5" className="cl-referral-orbit-dot" />
      </g>
      <g className="cl-referral-person">
        <circle cx="36" cy="28" r="9" fill={p.fill} stroke={p.stroke} strokeWidth="2" {...strokeProps} />
        <path d="M22 54c2-10 8-14 14-14s12 4 14 14" fill={p.fill} stroke={p.stroke} strokeWidth="2" {...strokeProps} />
      </g>
    </HandDrawnSvg>
  );
}
  ...
  return (
    <HandDrawnSvg className={`cl-art-vpd ${className}`}>
      <g className="cl-vpd-group">
        <path d="M36 14l19 16-19 28L17 30l19-16z" fill={p.fill} stroke={p.stroke} strokeWidth="2" {...strokeProps} />
...
function HandDrawnSvg({ className, children }: { className?: string; children: React.ReactNode }) {
  return (
    <svg
      viewBox="0 0 72 72"
      fill="none"
