          ...
          return (
            ...
            >
              ...
              <div className="relative z-[1] flex flex-col items-center justify-center gap-0.5">
                <h4 className="text-[11px] font-semibold leading-tight text-slate-900 dark:text-white">{tool.name}</h4>
                <p className="text-[9px] leading-snug text-slate-500 dark:text-slate-400">{tool.desc}</p>
              </div>
            </button>
          );
        })}
