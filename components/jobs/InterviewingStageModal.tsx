    ...
    >
        ...
        >
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                A strong <span className="font-semibold text-slate-900 dark:text-white">Value Proposition Document (VPD)</span>{' '}
                increases your chances of cracking the interview by helping you articulate impact clearly.
            </p>
