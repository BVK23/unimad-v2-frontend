    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-900 to-slate-900 rounded-xl p-5 text-white shadow-md relative overflow-hidden group">
                ...
                <span className="inline-block px-2 py-0.5 rounded text-[10px] font-medium bg-brand-500 mb-2">
                    LIVE TODAY
                </span>
            ...
            <div className="bg-white dark:bg-white/5 rounded-xl border border-slate-200 dark:border-white/5 shadow-sm p-4">
                ...
                <div className="flex flex-wrap gap-2">
                    {['#RemoteWork', '#AI', '#DesignSystems', '#React', '#CareerTips'].map(tag => (
                        <span key={tag} className="px-3 py-1 bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 text-slate-600 dark:text-slate-300 text-xs rounded-full cursor-pointer transition-colors border border-slate-200 dark:border-white/5">
                            {tag}
                        </span>
                    ))}
                </div>
