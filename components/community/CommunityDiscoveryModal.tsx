      ...
      <div className="relative bg-white dark:bg-slate-950 w-full max-w-2xl rounded-2xl shadow-2xl border border-slate-200 dark:border-white/10 overflow-hidden flex flex-col max-h-[80vh]">
        ...
        <div className="overflow-y-auto p-4 grid grid-cols-1 md:grid-cols-2 gap-3">
          {ALL_COMMUNITIES.map(comm => (
            <div
              key={comm.name}
              className="flex items-center justify-between p-3 rounded-xl border border-slate-100 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/20 transition-all group bg-white dark:bg-white/[0.02]"
            >
