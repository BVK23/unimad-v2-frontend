        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="col-span-1 lg:col-span-10">
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="hidden lg:block mb-6">
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Connect with fellow designers and creative technologists.
                  </p>
                </div>
                {/* MOBILE HEADER */}
                ...
                <div className="flex flex-col">
                  {MOCK_POSTS.map(post => (
                    <PostCard key={post.id} post={post} onViewProfile={handleViewProfile} onNavToCommunity={handleViewCommunity} />
                  ))}
                </div>
              </div>
            )}
            ...
            {view === "community" && selectedCommunityId && (
              <div className="max-w-4xl mx-auto">
                <CommunityPage communityId={selectedCommunityId} onBack={handleBackToFeed} onViewProfile={handleViewProfile} />
              </div>
            )}
