...
const NavigationSidebar: React.FC<NavigationSidebarProps> = ({ onSeeAllClick, onSelectCommunity, onMessagesClick, activeTab = "home" }) => {
  return (
      ...
      <div>
        ...
        <div className="px-0 pb-2">
          <nav className="space-y-0.5">
            ...
            <NavItem icon={MessageCircle} label="Messages" isActive={activeTab === "messages"} onClick={onMessagesClick} badge={3} />
...
const NavItem = ({
  ...
  >
    ...
    {badge && <span className="bg-brand-500 text-white text-[10px] px-1.5 py-0.5 rounded-full min-w-[18px] text-center">{badge}</span>}
  </button>
);
