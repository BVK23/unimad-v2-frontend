...
export const MOCK_CHATS: Conversation[] = [
    {
        id: '1',
        user: { id: 'u2', name: 'Sarah Chen', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80', status: 'online' },
    ...
    {
        id: '2',
        user: { id: 'u3', name: 'Mike Ross', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&q=80', status: 'offline' },
    ...
    {
        id: '3',
        user: { id: 'u4', name: 'Jessica Pearson', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&q=80', status: 'away' },
        lastMessage: { id: 'm4', senderId: 'u4', content: 'Let\'s schedule a call.', timestamp: '3d ago', isRead: true },
        unreadCount: 0,
        messages: [
            { id: 'm4', senderId: 'u4', content: 'Let\'s schedule a call.', timestamp: 'Mon', isRead: true },
        ]
    }
];
