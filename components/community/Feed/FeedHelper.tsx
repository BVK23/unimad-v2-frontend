...
export const MOCK_POSTS: Post[] = [
  {
    ...
    content:
      "I've been running some A/B tests on our main landing page. Changing the contrast ratio on our CTA buttons increased click-throughs by 15%. It's fascinating how small changes impact user behavior. \n\nHas anyone else seen similar results?",
  ...
  },
  {
    ...
    content:
      "Join our team and help build the future of cloud computing. We are looking for experienced PMs to lead our infrastructure initiatives.",
    timestamp: "Promoted",
    likes: 45,
    comments: 2,
    shares: 5,
  ...
  },
  {
    ...
    content:
      "I'll be giving a lightning talk on state management patterns. Would love to meet up with folks from this community! Let's connect! ⚡️",
