...
const CommunityPage: React.FC<CommunityPageProps> = ({ communityId, onBack, onViewProfile }) => {
    ...
    const communityInfo = {
        name: "UX/UI Design",
        icon: "🎨",
        description: "The place to share and discuss everything related to User Experience and User Interface optimization. Show your work, ask for feedback, and grow together.",
        members: "142k",
        online: "1.2k",
        ...
        <div className="animate-in fade-in duration-300">
            ...
            <div className="bg-white dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/5 overflow-hidden shadow-sm mb-6">
                <div className="h-32 bg-slate-200 relative">
                    <img src={communityInfo.bannerUrl} alt="Banner" className="w-full h-full object-cover" />
                </div>
                <div className="px-6 pb-6">
                    <div className="flex justify-between items-start">
                        <div className="flex gap-4 -mt-6">
                            ...
                            <div className="mt-8">
                                ...
                                <p className="text-sm text-slate-500 dark:text-slate-400 flex items-center gap-3 mt-1">
                                    <span className="flex items-center gap-1"><Users size={14} /> {communityInfo.members} members</span>
                                    <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-green-500"></span> {communityInfo.online} online</span>
                                </p>
                            </div>
                        </div>
                        <div className="mt-4 flex gap-2">
                            ...
                            <button
                                ...
                                className={`px-6 py-2 rounded-lg font-medium text-sm transition-colors ${isJoined
                    ...
                    <p className="mt-4 text-slate-600 dark:text-slate-300 max-w-2xl leading-relaxed text-sm">
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                                Welcome to correct our new members! Please read the rules before posting.
                                Join us every Friday for our "Design Critique" session at 4 PM EST.
                            </p>
