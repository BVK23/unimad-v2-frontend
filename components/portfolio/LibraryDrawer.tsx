...
const LIBRARY_BLOCKS: BlockLibraryItem[] = [
  // Start / Hero
  { id: 'h1', type: 'hero', variant: 'centered', name: 'Centered Hero', description: 'Bold text centered on the page', category: 'Start', icon: <Layout size={20} /> },
  { id: 'h2', type: 'hero', variant: 'split', name: 'Split Hero', description: 'Text on left, image on right', category: 'Start', icon: <Grid size={20} /> },
  { id: 'h3', type: 'hero', variant: 'full-bg', name: 'Impact Hero', description: 'Full-screen background image', category: 'Start', icon: <ImageIcon size={20} /> },
  
  // Proof
  { id: 'p1', type: 'proof_gallery', variant: 'grid_3col', name: 'Project Grid', description: '3-column visual card grid', category: 'Proof', icon: <Grid size={20} /> },
  { id: 'p2', type: 'proof_casestudy', variant: 'list', name: 'Case Study List', description: 'Text-based project summaries', category: 'Proof', icon: <List size={20} /> },
  
  // Authority
  { id: 'a1', type: 'authority_metrics', variant: 'grid', name: 'ROI Metrics', description: 'Bold numbers and impact', category: 'Authority', icon: <BarChart3 size={20} /> },
  { id: 'a2', type: 'authority_stack', variant: 'grid', name: 'Tech Stack', description: 'Logo grid of your tools', category: 'Authority', icon: <Layout size={20} /> },
  
  // Narrative
  { id: 'n1', type: 'narrative_bio', variant: 'standard', name: 'Clean Bio', description: 'Story-focused personal intro', category: 'Narrative', icon: <User size={20} /> },
  { id: 'n2', type: 'narrative_timeline', variant: 'vertical', name: 'Career Timeline', description: 'Interactive time-indexed path', category: 'Narrative', icon: <List size={20} /> },
  
  // CTA
  { id: 'c1', type: 'cta_contact', variant: 'contact', name: 'Contact Form', description: 'Modern lead capture section', category: 'CTA', icon: <Mail size={20} /> },
  { id: 'c2', type: 'cta_calendly', variant: 'calendly', name: 'Calendly Embed', description: 'Direct booking scheduler', category: 'CTA', icon: <Calendar size={20} /> },
];
...
const LibraryDrawer: React.FC<LibraryDrawerProps> = ({ isOpen, onClose, onAddBlock }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-hidden pointer-events-none">
      ...
      {/* Drawer */}
      <div className={`absolute right-0 top-0 bottom-0 w-full max-w-sm bg-white dark:bg-slate-950 shadow-2xl transition-transform duration-300 transform pointer-events-auto border-l border-slate-200 dark:border-slate-800 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
