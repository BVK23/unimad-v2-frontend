...
import { Copy, ThumbsUp, MessageSquare, Repeat, Send, MoreHorizontal, Globe, Wand2, ExternalLink, Download, Plus, FileText, ChevronLeft, Calendar, Clock, History, Trash2, Image as ImageIcon, Video, FileSpreadsheet, ChevronDown, ChevronUp, Upload } from 'lucide-react';
...
// Mock History
const MOCK_HISTORY = [
    { id: 101, content: "Excited to share that I've joined Unimad as a Product Designer! 🚀", stats: "1.2k views • 45 likes", date: "2 days ago" },
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {MOCK_VPDS.map(vpd => (
                                    <div key={vpd.id} className="p-4 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 flex items-center gap-3 cursor-pointer hover:border-blue-500 transition-all">
