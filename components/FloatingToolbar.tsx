...
import { Layout, Edit3, Type, Image as ImageIcon, Video, FolderPlus, Code, Briefcase, List, Link as LinkIcon } from "lucide-react";
    ...
    <div className="fixed bottom-8 right-8 z-50 flex items-center gap-3">
      ...
      >
        <div className="flex items-center gap-1 overflow-x-auto no-scrollbar">
          <button
            onClick={() => onAddItem("project")}
            className="p-3 rounded-full hover:bg-brand-50 text-slate-600 hover:text-brand-600 transition-colors flex flex-col items-center gap-1 min-w-[4rem]"
            title="Project"
          >
            <FolderPlus size={20} />
          ...
          <button
            ...
            className="p-3 rounded-full hover:bg-brand-50 text-slate-600 hover:text-brand-600 transition-colors flex flex-col items-center gap-1 min-w-[3.5rem]"
            title="Text"
          >
            <Type size={20} />
